    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'sku' => [
                ...
                'string',
                'max:100',
                Rule::unique('products', 'sku')->where(fn ($query) => $query->where('store_id', $store->id)),
            ],
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if (empty($offer['duration_days']) && empty($offer['duration_hours'])) {
                $validator->errors()->add('offer.duration_days', __('validation.custom.product.offer_duration_required'));
            }
